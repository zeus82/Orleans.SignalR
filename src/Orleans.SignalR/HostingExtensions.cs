...
namespace Orleans.Hosting
{
    public static class SiloBuilderExtensions
    {
        public static ISiloBuilder UseSignalR(this ISiloBuilder builder, Action<SignalrOrleansSiloConfigBuilder> configure = null)
        {
            ...
            return builder
                .AddSimpleMessageStreamProvider(SignalrConstants.STREAM_PROVIDER, opt => opt.FireAndForgetDelivery = cfg.UseFireAndForgetDelivery)
    ...
    internal class SignalRConfigurationValidator : IConfigurationValidator
    {
        ...
        public void ValidateConfiguration()
        {
            ...
            var pubSubProvider = this._sp.GetServiceByName<IGrainStorage>(SignalrConstants.PUBSUB_PROVIDER);
