...
#pragma warning restore 618
            ...
            try { builder.AddMemoryGrainStorage(SignalrConstants.PUBSUB_PROVIDER); }
            catch { /** PubSubStore was already added. Do nothing. **/ }

            try { builder.AddMemoryGrainStorage(SignalrConstants.STORAGE_PROVIDER); }
            catch { /** Grain storage provider was already added. Do nothing. **/ }

            return builder
                .AddSimpleMessageStreamProvider(SignalrConstants.STREAM_PROVIDER, opt => opt.FireAndForgetDelivery = config.UseFireAndForgetDelivery)
    ...
    public static class OrleansClientExtensions
    {
        ...
        public static IClientBuilder UseSignalR(this IClientBuilder builder, SignalrClientConfig config = null)
        {
            ...
            return builder.AddSimpleMessageStreamProvider(SignalrConstants.STREAM_PROVIDER, opt => opt.FireAndForgetDelivery = config.UseFireAndForgetDelivery)
